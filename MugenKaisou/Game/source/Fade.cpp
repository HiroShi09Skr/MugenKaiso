...
void Fade::ProcessColorFade() {
	...
	if (IsColorFade() != 0) {
		gFadeCnt++;
		gColorMaskR = static_cast<int>(myMath.EasingLinear(gFadeCnt, gColorFadeStR, gColorFadeEdR, gFadeFrames));
		gColorMaskG = static_cast<int>(myMath.EasingLinear(gFadeCnt, gColorFadeStG, gColorFadeEdG, gFadeFrames));
		gColorMaskB = static_cast<int>(myMath.EasingLinear(gFadeCnt, gColorFadeStB, gColorFadeEdB, gFadeFrames));
		gColorMaskA = static_cast<int>(myMath.EasingLinear(gFadeCnt, gColorFadeStA, gColorFadeEdA, gFadeFrames));
	}
}
