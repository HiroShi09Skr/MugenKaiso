...
void RoomGrave::SetSpown(Chara& chara, Camera& cam) {
	RoomBase::SetSpown(chara, cam);

	// キャラ
	chara._vPos = VGet(0.f, 600.f, 1400.f);
	chara._vResPos = chara._vPos;
...
void RoomGrave::Process(Chara& chara, VECTOR& v, VECTOR oldv) {
	...
	if (flgEffect) {
		gGlobal._effekseer.AddEffect("res/Effect/sakura/sakura.efkefc", chara._vPos.x, chara._vPos.y, chara._vPos.z, -1);
